                              ...
                              children: [
                                Padding(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.network(
                                      'https://flagcdn.com/h80/${listViewCountriesRecord.code.toLowerCase()}.png',
                                      width: 50.0,
                                      height: 50.0,
                                      fit: BoxFit.cover,
                                    ),
                                ...
                                Flexible(
                                  child: Text(
                                    '${listViewCountriesRecord.dialCode} ${listViewCountriesRecord.name}',
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.network(
                                      'https://flagcdn.com/h80/${dataItem.code.toLowerCase()}.png',
                                      width: 50.0,
                                      height: 50.0,
                                      fit: BoxFit.cover,
                                    ),
                                ...
                                Flexible(
                                  child: Text(
                                    '${dataItem.dialCode} ${dataItem.name}',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
