...
class AbcdWidget extends StatefulWidget {
  const AbcdWidget({super.key});

  static String routeName = 'abcd';
  static String routePath = '/abcd';

  @override
  State<AbcdWidget> createState() => _AbcdWidgetState();
}

class _AbcdWidgetState extends State<AbcdWidget> {
  late AbcdModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AbcdModel());
  }
